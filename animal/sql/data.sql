...
/* 쪽지 내용 입력 */
insert into Message(MEM_NUM,MEM_NUM2,MSG_CONTENT,CHECKED,SEND_DATE) values(1,2,'HIHI',true,now());
insert into Message(MEM_NUM,MEM_NUM2,MSG_CONTENT,CHECKED,SEND_DATE) values(2,1,'HELLO',true,now());
insert into Message(MEM_NUM,MEM_NUM2,MSG_CONTENT,CHECKED,SEND_DATE) values(3,2,'GAY',false,now());
