-- 쪽지
ALTER TABLE RECIEVEBOX
  DROP FOREIGN KEY FK_Member_TO_RECIEVEBOX; -- 회원 -> 쪽지

-- 쪽지
ALTER TABLE RECIEVEBOX
  DROP FOREIGN KEY FK_Member_TO_RECIEVEBOX2; -- 회원 -> 쪽지2
...
-- 쪽지
DROP TABLE IF EXISTS RECIEVEBOX RESTRICT;
...
-- 쪽지2
DROP TABLE IF EXISTS SENDBOX RESTRICT;
...
-- 쪽지
ALTER TABLE RECIEVEBOX
  ADD CONSTRAINT PK_RECIEVEBOX -- 쪽지 기본키
    PRIMARY KEY (
      MSG_NUM -- 쪽지번호
    );
...
-- 쪽지2
ALTER TABLE SENDBOX
  ADD CONSTRAINT PK_SENDBOX -- 쪽지2 기본키
    PRIMARY KEY (
      MSG_NUM -- 쪽지번호
    );
...
-- 쪽지
ALTER TABLE RECIEVEBOX
  ADD CONSTRAINT FK_Member_TO_RECIEVEBOX -- 회원 -> 쪽지
    FOREIGN KEY (
      MEM_NUM -- 보내는이
    )
...
-- 쪽지
ALTER TABLE RECIEVEBOX
  ADD CONSTRAINT FK_Member_TO_RECIEVEBOX2 -- 회원 -> 쪽지2
    FOREIGN KEY (
      MEM_NUM2 -- 받는이
    )
    REFERENCES Member ( -- 회원
