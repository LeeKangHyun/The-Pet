...
/* 교육 내용 입력 */
insert into Education(EDU_TITLE,EDU_CONTENT,EDU_DIV,EDU_CRE)
  values('포메라이안 교육','교육이다아아앙1','개','2016-01-01');
insert into Education(EDU_TITLE,EDU_CONTENT,EDU_DIV,EDU_CRE)
  values('냐옹이 교육','교육이다아아앙2','고양이','2016-01-01');
insert into Education(EDU_TITLE,EDU_CONTENT,EDU_DIV,EDU_CRE)
  values('송사리 교육','교육이다아아앙3','물고기','2016-01-01');
insert into Education(EDU_TITLE,EDU_CONTENT,EDU_DIV,EDU_CRE)
  values('상어 교육','교육이다아아앙4','물고기','2016-01-01');
insert into Education(EDU_TITLE,EDU_CONTENT,EDU_DIV,EDU_CRE)
  values('앵무새 교육','교육이다아아앙5','새','2016-01-01');
insert into Education(EDU_TITLE,EDU_CONTENT,EDU_DIV,EDU_CRE)
  values('악어 교육','교육이다아아앙6','ETC','2016-01-01');
insert into Education(EDU_TITLE,EDU_CONTENT,EDU_DIV,EDU_CRE)
  values('타조 교육','교육이다아아앙7','새','2016-01-01');_CONTENT,EDU_DIV,EDU_CRE)
  values('시베리안 허스키 교육','교육이다아아앙8','개','2016-01-01');
insert into Education(EDU_TITLE,EDU_CONTENT,EDU_DIV,EDU_CRE)
  values('페르시안 교육','교육이다아아앙9','고양이','2016-01-01');
insert into Education(EDU_TITLE,EDU_CONTENT,EDU_DIV,EDU_CRE)
  values('터키 앙고라 교육','교육이다아아앙10','고양이','2016-01-01');
insert into Education(EDU_TITLE,EDU
...
/* 짝짓기 내용 추가 */
insert into Mating(MAT_TITLE,MAT_CONTENT,MAT_DIV,MAT_SPECIES,MAT_SEX,MAT_CRE)
  values('우리 아이 짝짓기 부탁해요~~~1','서울 강남역 근처로 부탁드려요~','개','포메라이안','여자','2016-01-01');
insert into Mating(MAT_TITLE,MAT_CONTENT,MAT_DIV,MAT_SPECIES,MAT_SEX,MAT_CRE)
  values('우리 아이 짝짓기 부탁해요~~~2','서울 강남역 근처로 부탁드려요~','고양이','페르시안','남자','2016-01-01');
insert into Mating(MAT_TITLE,MAT_CONTENT,MAT_DIV,MAT_SPECIES,MAT_SEX,MAT_CRE)
  values('우리 아이 짝짓기 부탁해요~~~3','서울 강남역 근처로 부탁드려요~','개','시베리안허스키','여자','2016-01-01');
insert into Mating(MAT_TITLE,MAT_CONTENT,MAT_DIV,MAT_SPECIES,MAT_SEX,MAT_CRE)
  values('우리 아이 짝짓기 부탁해요~~~4','서울 강남역 근처로 부탁드려요~','개','슈나우져','여자','2016-01-01');
insert into Mating(MAT_TITLE,MAT_CONTENT,MAT_DIV,MAT_SPECIES,MAT_SEX,MAT_CRE)
  values('우리 아이 짝짓기 부탁해요~~~5','서울 강남역 근처로 부탁드려요~','개','불독','여자','2016-01-01');
insert into Mating(MAT_TITLE,MAT_CONTENT,MAT_DIV,MAT_SPECIES,MAT_SEX,MAT_CRE)
  values('우리 아이 짝짓기 부탁해요~~~6','서울 강남역 근처로 부탁드려요~','고양이','집고양이','남자','2016-01-01');
insert into Mating(MAT_TITLE,MAT_CONTENT,MAT_DIV,MAT_SPECIES,MAT_SEX,MAT_CRE)
  values('우리 아이 짝짓기 부탁해요~~~7','우리 아이 부탁드려요~~~~','ETC','악어','여자','2016-01-01');
insert into Mating(MAT_TITLE,MAT_CONTENT,MAT_DIV,MAT_SPECIES,MAT_SEX,MAT_CRE)
  values('우리 아이 짝짓기 부탁해요~~~8','나이는 어려용~~~','새','비둘기','남자','2016-01-01');
insert into Mating(MAT_TITLE,MAT_CONTENT,MAT_DIV,MAT_SPECIES,MAT_SEX,MAT_CRE)
  values('우리 아이 짝짓기 부탁해요~~~9','서울 강남역 근처로 부탁드려요~','새','앵무새','남자','2016-01-01');
insert into Mating(MAT_TITLE,MAT_CONTENT,MAT_DIV,MAT_SPECIES,MAT_SEX,MAT_CRE)
  values('우리 아이 짝짓기 부탁해요~~~10','서울 강남역 근처로 부탁드려요~','개','누렁이','남자','2016-01-01');
insert into Mating(MAT_TITLE,MAT_CONTENT,MAT_DIV,MAT_SPECIES,MAT_SEX,MAT_CRE)
  values('우리 아이 한번 하게 해주~~~11','서울 강남역 근처로 부탁드려요~','개','진돗개','남자','2016-01-01');

/* 분양 글쓰기 */
insert into Parcel_Out(PO_TITLE,PO_CONTENT,PO_DIV,PO_SPECIES,PO_CREDT)
  values('퓨마 분양해드려요~~','급한 사정이 있어 빠른 분양 부탁드려요ㅠㅠ','ETC','퓨마','2016-01-01');
insert into Parcel_Out(PO_TITLE,PO_CONTENT,PO_DIV,PO_SPECIES,PO_CREDT)
  values('콩이 분양해드려요~~','급한 사정이 있어 빠른 분양 부탁드려요ㅠㅠ','개','시츄','2016-01-01');
insert into Parcel_Out(PO_TITLE,PO_CONTENT,PO_DIV,PO_SPECIES,PO_CREDT)
  values('츄롤리 분양해드려요~~','급한 사정이 있어 빠른 분양 부탁드려요ㅠㅠ','ETC','거북이','2016-01-01');
insert into Parcel_Out(PO_TITLE,PO_CONTENT,PO_DIV,PO_SPECIES,PO_CREDT)
  values('꽐라 분양해드려요~~','급한 사정이 있어 빠른 분양 부탁드려요ㅠㅠ','ETC','코알라','2016-01-01');
insert into Parcel_Out(PO_TITLE,PO_CONTENT,PO_DIV,PO_SPECIES,PO_CREDT)
  values('꽁양이 분양해드려요~~','급한 사정이 있어 빠른 분양 부탁드려요ㅠㅠ','새','앵무새','2016-01-01');
insert into Parcel_Out(PO_TITLE,PO_CONTENT,PO_DIV,PO_SPECIES,MEM_NUM,PO_CREDT)
  values('퓨마 분양해드려요~~','급한 사정이 있어 빠른 분양 부탁드려요ㅠㅠ','ETC','퓨마',1,'2016-01-01');
insert into Parcel_Out(PO_TITLE,PO_CONTENT,PO_DIV,PO_SPECIES,MEM_NUM,PO_CREDT)
  values('콩이 분양해드려요~~','급한 사정이 있어 빠른 분양 부탁드려요ㅠㅠ','개','시츄',2,'2016-01-01');
insert into Parcel_Out(PO_TITLE,PO_CONTENT,PO_DIV,PO_SPECIES,MEM_NUM,PO_CREDT)
  values('츄롤리 분양해드려요~~','급한 사정이 있어 빠른 분양 부탁드려요ㅠㅠ','ETC','거북이',2,'2016-01-01');
insert into Parcel_Out(PO_TITLE,PO_CONTENT,PO_DIV,PO_SPECIES,MEM_NUM,PO_CREDT)
  values('꽐라 분양해드려요~~','급한 사정이 있어 빠른 분양 부탁드려요ㅠㅠ','ETC','코알라',3,'2016-01-01');
insert into Parcel_Out(PO_TITLE,PO_CONTENT,PO_DIV,PO_SPECIES,MEM_NUM,PO_CREDT)
  values('꽁양이 분양해드려요~~','급한 사정이 있어 빠른 분양 부탁드려요ㅠㅠ','새','앵무새',4,'2016-01-01');
